...
<body>
                            ...
                            @foreach ($data as $key)
                                @if ($key->amount > 0)
                                    @php
                                        ...
                                        if ($users->count() > 0) {
                                            ...
                                            if($user->last_payment_date == null)  {
                                                ...
                                                $last_payment = date('d-m-Y', strtotime($user->last_payment_date)).'<br> ( '.$user->last_payment_period.' )';
                                            }
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space:nowrap;"><?= $last_payment ;?>
                                        </td>
                                    </tr>
                                @endif
                            @endforeach
    ...
    <script>
        ...
        $("#btn-pdf").click(function() {
            ...
            window.open("{{ url('backdata/print_kas_detail_pdf') }}" + "/" + awal + "/" + akhir + "/" + payment +
                "/" + penyelia, "_blank");
        })
